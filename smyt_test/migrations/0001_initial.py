...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Users'
        db.create_table(u'smyt_test_users', (
        ...
        db.send_create_signal('smyt_test', ['Users'])

        # Adding model 'Rooms'
        db.create_table(u'smyt_test_rooms', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('department', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('spots', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('smyt_test', ['Rooms'])


    def backwards(self, orm):
        # Deleting model 'Users'
        db.delete_table(u'smyt_test_users')

        # Deleting model 'Rooms'
        db.delete_table(u'smyt_test_rooms')
